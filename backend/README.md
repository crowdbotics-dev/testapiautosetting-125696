...
## Project Structure
    ...
    ├── testapiautosetting_125696  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125696`
...
2. Clone this repo and `cd testapiautosetting_125696`
